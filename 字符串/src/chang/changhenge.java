...
public static void main(String args[] ) {
	   ...
	   for (int i = 7;i<s.length();i+=15) {
    	   s.insert(i, "，");
            }
       /*
                * 从第八个组为第一个添加逗号的地方，而后每隔7位，即在第八位添加逗号
        */
       ...
       String input = scan.nextLine();  //输入汉字或字符
      /*
       * 异常处理
       */
       if (input != null) {
    	  System.out.println("包含次数为："+count(s.toString(),input));  //统计个数并且打印出
       }else {
